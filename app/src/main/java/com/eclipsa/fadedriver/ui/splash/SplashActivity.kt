package com.eclipsa.fadedriver.ui.splash
...
import com.eclipsa.fadedriver.ui.get_started.GetStartedActivity
import com.eclipsa.fadedriver.ui.get_started_new.GetStartedNewActivity
...
import com.eclipsa.fadedriver.utils.ManagePermissions
import com.eclipsa.fadedriver.utils.Prefrences
import com.eclipsa.fadedriver.utils.Utils
import com.eclipsa.fadedriver.utils.Utils.openNoInternetConnectionActivity
            ...
            if (userId!!.isNotEmpty()) {
                if (isServiceAdded == "0") {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
                        if (managePermissions.checkPermissions()) {
                            Handler().postDelayed({
                                val intent = Intent(this, com.eclipsa.fadedriver.MainActivity::class.java)
                                startActivity(intent)
                                finish()
                            }, 2000)
                        }
