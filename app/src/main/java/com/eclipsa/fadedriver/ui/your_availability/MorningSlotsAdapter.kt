...
import com.eclipsa.fadedriver.databinding.ItemDriverSlotsBinding
import com.eclipsa.fadedriver.extension.setColor
...
class MorningSlotsAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (slot.isSelected){
            holder.binding.tvSlotTime.setTextColor(ContextCompat.getColor(this.context, R.color.white))
            holder.binding.tvSlotTime.background = ResourcesCompat.getDrawable(context.resources, R.drawable.drawable_black_rounded_corner_bg, null)
        } else {
