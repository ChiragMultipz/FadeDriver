...
import com.eclipsa.fadedriver.ReviewImageItem
import com.eclipsa.fadedriver.databinding.ActivityBookingDetailsBinding
...
class BookingDetailsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    var reviewImagesList: ArrayList<com.eclipsa.fadedriver.ReviewImageItem> = ArrayList<com.eclipsa.fadedriver.ReviewImageItem>()
