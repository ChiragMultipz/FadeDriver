...
import com.eclipsa.fadedriver.MainActivity
import com.eclipsa.fadedriver.R
import com.eclipsa.fadedriver.databinding.ActivityCodeVerifyBinding
import com.eclipsa.fadedriver.extension.hideKeyboard
import com.eclipsa.fadedriver.extension.snackBar
...
import com.eclipsa.fadedriver.ui.profile.ProfileActivity
import com.eclipsa.fadedriver.ui.profile.ResultNew
import com.eclipsa.fadedriver.ui.select_radius.SelectRadiusActivity
import com.eclipsa.fadedriver.ui.select_services.SelectServicesActivity
import com.eclipsa.fadedriver.ui.your_availability.YourAvailabilityActivity
import com.eclipsa.fadedriver.utils.Constants
import com.eclipsa.fadedriver.utils.Prefrences
import com.eclipsa.fadedriver.utils.Utils
import com.eclipsa.fadedriver.utils.Utils.enable
...
class CodeVerifyActivity : AppCompatActivity(), View.OnClickListener {
                        ...
                        if (it.value.message!!.contains("User Not Found")) {
                            ...
                            if (it.value.result != null) {
                                ...
                                if (it.value.result.roleId == 2) {
                                    when {
                                        it.value.result.isServiceAdded == 0 -> {
                                        ...
                                        it.value.result.isAvailability == 0 -> {
                                            var intent =
                                        ...
                                        it.value.result.maxRadius!!.isEmpty() -> {
                                            ...
                                            var intent = Intent(this, com.eclipsa.fadedriver.MainActivity::class.java)
                                            intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
                                            startActivity(intent)
                                            finish()
                                        }
    ...
    private fun savePreferences(data: ResultNew) {
        Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.USER_ID, data.id.toString())
        Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.ROLE_ID, data.roleId!!.toString())
        Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.USER_MOBILE_NO, data.mobile!!.toString())
        ...
        Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.ADDRESS_LINE_1, data.addressLine1!!)
        Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.ADDRESS_LINE_2, data.addressLine2!!)
        Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.ADDRESS_LINE_2, data.addressLine2)
        Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.POSTAL_CODE, data.postalCode!!)
        ...
        if(data.city?.id != null){
            Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.CITY_ID, data.city.id.toString())
            Prefrences.savePreferencesString(this@CodeVerifyActivity, Constants.CITY_NAME, data.city.name!!)
        }
